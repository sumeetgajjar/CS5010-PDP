...
public class ImmutableListADTImpl<T> implements ImmutableListADT<T> {
  ...
  private static class ImmutableListADTImplBuilder<E> implements ImmutableListADTBuilder<E> {
    ...
    /**
     * Add each element of given {@link ListADT} to the {@link ImmutableListADT}. Mutating the given
     * listADT does not mutate the ImmutableList which will be generated by <code>build()</code>
     * method. It throws {@link IllegalArgumentException} is the given list is null.
     *
