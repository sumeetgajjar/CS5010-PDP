 ...
 * a simple example of run-length encoding. The look-and-say sequence can also be computed in
 * reverse. For example 2112131211 can be reversed by taking digits two at a time, and writing them
 * out (write two 1s, then one 2, and so on). This produces 112321.
 */
